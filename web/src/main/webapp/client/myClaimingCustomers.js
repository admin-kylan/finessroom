var myClaimingCustomers = new Vue({
    el: '#myClaimingCustomers',
    data: {
        //我的现有客户筛选
        customerFilter: {
            //性别
    ...
    methods: {
        ...
        queryAll: function () {
            if ($("#pcheckbox").is(":checked") == true) {
                $("#myClaimingCustomers").find('input').prop("checked", true);//全选
            } else {
                $("#myClaimingCustomers").find('input').prop("checked", false);//取消
            }
        },
        //打印
        print: function () {
...
jeDate('.startDate', {
    ...
    donefun: function (obj) {
        myClaimingCustomers.customerFilter.startTime = obj.val;
        //重载数据
        myClaimingCustomers.buildFilterDate();
    }
});
...
jeDate('.endDate', {
    format: "YYYY-MM-DD",
    donefun: function (obj) {
        myClaimingCustomers.customerFilter.endTime = obj.val;
        //重载数据
        myClaimingCustomers.buildFilterDate();
    }
});
